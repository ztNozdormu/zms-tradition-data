...
```bash
  -- create market_kline
  1. diesel migration generate create_market_kline
  2. diesel migration run
...
```
```bash
  -- create market_symbol
  1. diesel migration generate create_market_symbol
  2. diesel migration run
    ...
    CREATE TABLE market_symbol (
        ...
        order_types JSON NOT NULL COMMENT '订单类型数组',
        ...
        filters JSON NOT NULL COMMENT '过滤器规则',
