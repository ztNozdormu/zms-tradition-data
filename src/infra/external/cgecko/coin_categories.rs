...
//
// pub struct FetchCoinRequest(pub crate::infra::external::cgecko::coin_latest::CoinQueryParams);
//
...
// }
//
// impl RestRequest for crate::infra::external::cgecko::coin_latest::FetchCoinRequest {
//     type Response = crate::infra::external::cgecko::coin_latest::CoinResponse;
//     type QueryParams = crate::infra::external::cgecko::coin_latest::CoinQueryParams;
//     type Body = ();
//
...
// pub struct CoinResponse(pub Vec<crate::infra::external::cgecko::coin_latest::CoinListInfo>);
//
...
//     pub ath_date: DateTime<Utc>, // can also use chrono::DateTime<FixedOffset> if parsing
//     pub atl: f64,
//     pub atl_change_percentage: f64,
//     pub atl_date: String,
//     pub roi: Option<crate::infra::external::cgecko::coin_latest::RoiInfo>, // Can replace with typed struct if known
